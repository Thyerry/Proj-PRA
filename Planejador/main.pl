...
% Estrutura de um voo:
% voo(Cidade1, Cidade2, HoraDeSaída, MinutoDeSaida, HoraDeChegada, Minuto de Chegada, DiasDaSemana)
...
verHorario(Saida, Destino):- 
    voo(Saida, Destino, HSaida, MSaida, HChegada, MChegada, Dias),
    formataHora(HSaida, MSaida, HorarioSaida),
    formataHora(HChegada, MChegada, HorarioChegada),
    write("Horario de saida da viagem "),
    write(Saida),
    write(" -> "),
    writeln(Destino),
    write("Saida: "),
